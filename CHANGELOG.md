...
## 1.0.94
- Przeniesiono glosownik interlinearny do nowego panelu Narzędzia i poprawiono czytelność nagłówków w ciemnym motywie.

## 1.0.93
- Dodano lokalny glosownik interlinearny: własne glosy, eksport/import i pierwszeństwo nad słownikiem roboczym.

## 1.0.92
- Naprawiono rozkodowane polskie znaki w interfejsie i przywrócono poprawną mapę Unicode dla warstwy interlinearnej.

## 1.0.91
- Poszerzono słownik interlinearny, dodano rozpoznawanie częstych prefiksów koptyjskich i wyciszono nierozpoznane glosy.

## 1.0.90
- Dodano tryb interlinearny: koptyjska linia źródłowa, transliteracja techniczna i robocze glosy słowo po słowie.
...
## 1.0.86
- Dodano szybki przełącznik języka PL/EN oraz uproszczono nagłówek strony głównej.

## 1.0.85
- Zmieniono polski tytuł interfejsu na „Biblioteka gnozy” oraz dodano kopiowanie zaznaczonego fragmentu z przypisem.
